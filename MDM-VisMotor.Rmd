...
#save(mdm.s1, mdm.s2, mdm.s3, file = file.path(PATH, "data"", "vismotor.RData"))
...
## Correlation plot
```{r Correlation plot, fig.height=4, fig.width=6.2}
mylim = c(-0.8, 0.8)
...
plot_grid(p1, p2, p3, ncol = 1, nrow = 3, rel_widths = c(1, 1))
```

## Network consistency across subjects
```{r, Network consistency across subjects, fig.height=7, fig.width=6}

stats1 = binom.nettest(mdm.s1$am)
stats2 = binom.nettest(mdm.s2$am)
stats3 = binom.nettest(mdm.s3$am)
