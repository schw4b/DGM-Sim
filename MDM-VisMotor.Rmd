...
p4 = gplotMat(lpl4, title = "motor/visual", nodeLabels = mylabels, axisTextSize=8,
              xAngle=90, lim = c(min(lpl4), max(lpl4[lpl4 < 0]) ))
p5 = gplotMat(lpl5, title = "motor/visual II", nodeLabels = mylabels, axisTextSize=8,
              xAngle=90, lim = c(min(lpl5), max(lpl5[lpl5 < 0]) ))
...
# sum across runs
lpl = rmna(mdm.s1$lpl) + rmna(mdm.s2$lpl) + rmna(mdm.s3$lpl) + rmna(mdm.s4$lpl) +
  rmna(mdm.s5$lpl)
# sum across subjects
lpl = apply(lpl, c(1,2), sum)

p1 = gplotMat(stats$adj, title = "Common net", nodeLabels = mylabels, axisTextSize=8,
              xAngle=90)
...
p5 = gplotMat(lpl, title = "Common net sum(lpl)", nodeLabels = mylabels, axisTextSize=8,
              xAngle=90, lim = c(min(lpl), max(lpl[lpl < 0]) ))
...
```{r Mean/Variance of the theta_t across runs, fig.height=5, fig.width=6}
