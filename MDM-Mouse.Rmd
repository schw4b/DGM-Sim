...
p5 = gplotMat(stats3$adj, title = "Net1_WT", labels=mylabels, axisTextSize=8, xAngle=90)
p6 = gplotMat(rmna(stats3$adj_fdr), title = "binom test & FDR", labels=mylabels, axisTextSize=8, xAngle=90)

mylabels = c("SomSensR", "MotorR", "PutamR", "SomSensL", "MotorL", "PutamL")
p7 = gplotMat(stats4$adj, title = "Net2_WT", labels=mylabels, axisTextSize=8, xAngle=90)
p8 = gplotMat(rmna(stats4$adj_fdr), title = "binom test & FDR", labels=mylabels, axisTextSize=8, xAngle=90)
