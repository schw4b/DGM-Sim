...
PATH = file.path(PATH_HOME, 'Data', 'MDM-nbooks')
...
load(file.path(PATH, "data", "mdm-mouse.RData"))
...
```{r, Network consistency across mice, fig.height=4, fig.width=5.2}
...
plot_grid(p1, p2, p3, p4, ncol = 2, nrow = 2, rel_heights = c(1,1,1,1))

```


```{r, Network consistency across mice new data, fig.height=4, fig.width=5.2}
stats3 = binom.nettest(mdm.net1wt$am)
stats4 = binom.nettest(mdm.net2wt$am)

mylabels = c("OrbM", "OrbL", "NAcc", "Cing",  "Amyg", "CA1", "DG", "Entorh")
p5 = gplotMat(stats3$adj, title = "Net1_WT", nodeLabels=mylabels, axisTextSize=8, xAngle=90)
p6 = gplotMat(rmna(stats3$adj_fdr), title = "binom test & FDR", nodeLabels=mylabels, axisTextSize=8, xAngle=90)

mylabels = c("SomSensR", "MotorR", "PutamR", "SomSensL", "MotorL", "PutamL")
p7 = gplotMat(stats4$adj, title = "Net2_WT", nodeLabels=mylabels, axisTextSize=8, xAngle=90)
p8 = gplotMat(rmna(stats4$adj_fdr), title = "binom test & FDR", nodeLabels=mylabels, axisTextSize=8, xAngle=90)

plot_grid(p5, p6, p7, p8, ncol = 2, nrow = 2, rel_heights = c(1,1,1,1))
