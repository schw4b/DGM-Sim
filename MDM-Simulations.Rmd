...
p0 = ggplot(data=comput, aes(x=nodes, y=time)) + geom_bar(stat="identity", fill="steelblue") +
  geom_text(aes(label=c("0.2\nsec","0.5\nsec","1\nsec","2.2\nsec","4.8\nsec","10\nsec",
                        "22\nsec","48\nsec","2\nmin","4\nmin","8\nmin","38\nmin","30\nhrs","58\ndays")), size=3.5, vjust=-0.3) + theme_minimal() + ylab(expression('time s'^(1/3)))
...
mid=plot_grid(p1, p2, labels=c("A", "B"), ncol = 2, nrow = 1, rel_widths = c(1, 0.4))
...
p1 = ggplot(d1, aes(x=node, y=df)) + geom_violin() + geom_boxplot(width=0.2) + ggtitle("Sim1")
p2 = ggplot(d2, aes(x=node, y=df)) + geom_violin() + geom_boxplot(width=0.2) + ggtitle("Sim22")
p3 = ggplot(d3, aes(x=node, y=df)) + geom_violin() + geom_boxplot(width=0.2) + ggtitle("Int0")
p4 = ggplot(d4, aes(x=node, y=df)) + geom_violin() + geom_boxplot(width=0.2) + ggtitle("Int1")
p5 = ggplot(d5, aes(x=node, y=df)) + geom_violin() + geom_boxplot(width=0.2) + ggtitle("Int2")
p6 = ggplot(d6, aes(x=node, y=df)) + geom_violin() + geom_boxplot(width=0.2) + ggtitle("Int3")
p7 = ggplot(d7, aes(x=node, y=df)) + geom_violin() + geom_boxplot(width=0.2) + ggtitle("Int4")
p8 = ggplot(d8, aes(x=node, y=df)) + geom_violin() + geom_boxplot(width=0.2) + ggtitle("Int5")
p9 = ggplot(d9, aes(x=node, y=df)) + geom_violin() + geom_boxplot(width=0.2) + ggtitle("Int6")
...
```{r Plot: MDM sensitivity and specificity for the 7 HRF datasets, message=FALSE, warning=TRUE, fig.height=2, fig.width=6}
