...
### Mean Sensitivity and specificity for MDM and Patel's
apply(perf.mdm$sim1[,c(1,2)], 2, median)
apply(perf.mdm$sim22[,c(1,2)], 2, median)

apply(perf.pat$sim1[,c(1,2)], 2, median)
apply(perf.pat$sim22[,c(1,2)], 2, median)
