...
perf.dgm$noise  = perf(dgm.noise$tam, xtrue)
...
s = 0.2 # spacing
pA1=ggplot(melt(table.perf[1:3,c(1,5,6,7)]), aes(x=Var2, y=value, fill=Var1)) +
...
pA2=ggplot(melt(table.perf[1:3,c(2,8)]), aes(x=Var2, y=value, fill=Var1)) +
